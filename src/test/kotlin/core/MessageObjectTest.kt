...
class MessageObjectTest {
    ...
    fun registerUser() {
        ...
        var result = LoginController.register_user.exec(params)
        ...
        params.set("login","")
        result = LoginController.register_user.exec(params)
    ...
    fun loginUser() {
        ...
        val params = JSONObject()
        var result = LoginController.login_user.exec(params)
        ...
        params.set("login","")
        result = LoginController.login_user.exec(params)
        assertEquals("Should return error without login",Users.UserLoginResultCode.RESULT_ERROR_INCORRECT_LOGIN.toString(),result.get("status_code").toString())
    ...
    fun updateUser() {
        ...
        app.users.login(user!!["login"].toString(),user!!["password"].toString()) { p1,p2 ->
            ...
            var result = UserController.update_user.exec(params)
            assertTrue("Should return result as JSON object",result is JSONObject)
            ...
            result = UserController.update_user.exec(params)
    ...
    fun onWebSocketBinary() {
        ...
        app.users.register(params) { result_code,user ->
            ...
            var response = LoginController.login_user.exec(params)
